...
export function renderBambuMonitor(container, api) {
  ...
  let disposed = false, timer, refreshing = false, dailyDialog;
    ...
    try {
      ...
      for (const device of data.devices) {
        ...
        if (!fresh) {
          ...
          badge.append(icon, element('span', 'Sem sinal')); heading.append(badge);
        }
        ...
        cardActions.append(reportButton); heading.append(cardActions);
