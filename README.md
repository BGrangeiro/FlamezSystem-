...
O servidor local recebe relatórios pela nuvem, sem computador junto das impressoras e sem Bambu Studio aberto. Mostra progresso, tempo restante e status, quando informados. Impressoras devem permanecer conectadas à Bambu Cloud, e não em modo LAN-only. É necessário acesso de saída HTTPS e MQTT TLS na porta 8883.
